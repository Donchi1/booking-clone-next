...
//initial state and country
const initialState = statesData.find(state => state.name === values?.state!) as StateProps | null
const initialCountry = countriesData.find(country => country.name === values?.country!) as CountryProps | null
        ...
        <Popover open={openStateDropdown} onOpenChange={setOpenStateDropdown}>
          <PopoverTrigger asChild>
            <Button
              ...
              disabled={!selectedCountry || disabled?.state}
              className="w-full justify-between"
            >
              {selectedState ? (
